                        ...
                        <?php foreach ($departments as $department) { ?><!--  every row in department -->
                            <div class="col-sm-6 row d-flex justify-content-center m-0 p-1 ">
                                ...
                                <div class="row border d-flex justify-content-between p-2 color-white border h-100 ">
                                    ...
                                    $sql2 = 'SELECT * FROM `if0_37296747_admin`.`category` WHERE `department_id` = ?'; //request 
                                    ...
                                    <?php if (!empty($categories)) { ?>
                                        <?php foreach ($categories as $category) { ?>
                                            <a href="category.php?category_id=<?php echo urlencode($category['category_id']); ?>" class="col-md-5 border my-2 bg-light text-decoration-none text-dark">
